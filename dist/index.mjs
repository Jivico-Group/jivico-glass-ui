...
var CloseDeleteIcon = (props) => React.createElement(
  "svg",
  {
    viewBox: "0 0 24 24",
    fill: "none",
...
var GradientText = styled$1("span")(({ isDark }) => ({
...
var GradientContextTitle = styled$1(Typography)(({ isDark }) => ({
  fontWeight: 800,
  letterSpacing: "-0.04em",
  lineHeight: 1.2,
  fontSize: "1.35rem",
...
function JivicoFontPreload() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("link", { href: JIVICO_BRAND_FONTS_URL, rel: "stylesheet" })
  ] });
}
